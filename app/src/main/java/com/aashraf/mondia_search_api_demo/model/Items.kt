...
data class Items(
    ...
    @SerializedName("owner") val owner: OwnerModel? = null,
    ...
    @SerializedName("watchers_count") val watchers_count: Int = 0,
    @SerializedName("language") val language: String = "",
    @SerializedName("has_issues") val has_issues: Boolean = false,
    @SerializedName("has_projects") val has_projects: Boolean = false,
    @SerializedName("has_downloads") val has_downloads: Boolean = false,
    @SerializedName("has_wiki") val has_wiki: Boolean = false,
    @SerializedName("has_pages") val has_pages: Boolean = false,
    ...
    @SerializedName("open_issues_count") val open_issues_count: Int = 0,
    @SerializedName("license") val license: License,
    @SerializedName("forks") val forks: Int = 0,
    @SerializedName("open_issues") val open_issues: Int = 0,
    ...
    companion object {
        fun getList(): List<Items> {
            return listOf( Items(name = "", license = License(), score = 1.1))
        }
    }
}